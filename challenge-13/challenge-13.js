(function (){
    ...
    */
    var nordeste = ['Maranhão', 'Piaui', 'Bahia', 'Ceará'];
    ...
    */
    ...
    var setLetras = brasil.every(function(item){
        return item.length > 7
    });
    console.log(setLetras ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!');
