(function() {
    ...
    */
    ...
    var newText = text.replace(/Manuel Marques de Sousa/, 'Filipi Souza');
    console.log(newText);
    ...
    */
    ...
    newText = text.replace(/brasileiro/, 'fumacense');
    console.log(newText);
    ...
    */
    ...
    newText = newText.replace(/[D-h]/g, '0');
    console.log(newText);
    ...
    */
    ...
    newText = text.replace(/(O Centauro de Luvas)/g, (total, re) => {
    ...
    */
    ...
    let regexDate = /([0-9]+) de (junho|julho) de ([0-9]{4})/g;
